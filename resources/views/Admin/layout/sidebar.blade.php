<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Lowongan:</h6>
                <a class="collapse-item" href="{{route('lowongan.create')}}">Tambah Lowongan</a>
                <a class="collapse-item" href="{{route('lowongan.index')}}">List Lowongan</a>
                {{-- <a class="collapse-item" href="cards.html">List</a> --}}
            </div>
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Komunitas:</h6>
                <a class="collapse-item" href="{{route('komunitas.create')}}">Tambah Komunitas</a>
                <a class="collapse-item" href="{{route('komunitas.index')}}">List Komunitas</a>
                {{-- <a class="collapse-item" href="cards.html">List</a> --}}
            </div>
        </div>
    </li>
